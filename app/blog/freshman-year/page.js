    ...
    <PageLayout>
      ...
      <SectionWrapper className="page-content">
        ...
        <p className="body-1">
          ...
          experiment with my time management/moving into college and whatnot. 2
          of these were M325K: Discrete Math, and ARC308: Architecture and
          Society. The other 2 were required classes for Plan II that proved to
          be more eye-opening than expected:
        </p>
        <ul className="content-list">
          <li className="body-1">E303C: World Literature</li>
          <li className="body-1">TC302: Art, Sport, and the Meaning of Life</li>
        </ul>
        <p className="body-1">
          ...
          texts of world literature, including the Rig Veda, Theogony, The
          Qur'an, and more. The focus was on how gods and demons have been
          represented in literary texts throughout history. In TC302, we
          explored the value of art and sport in human history, and analyzed
          them from the broader perspective of how humans should live their
          lives. I spent a lot of time writing the final essay for this class,
          which earned me an A:
        </p>
        ...
        <p className="body-1">
          ...
          and play chess for a few hours. I met lots of cool people and soon
          found myself playing on the B team for the Collegiate Chess League
          (CCL), an online competition where we could compete against other
          colleges' teams every week.
        </p>
        ...
        <p className="body-1">
          ...
          out on average 5 days a week, ~1.5 hours a day, from September through
          early December (when finals season began).
        </p>
        <p className="body-1">
          ...
          200lbs, and my squat went from 150 to 210lbs (I've always been a squat
          skipper 😔... any tips appreciated). Overall, a very successful
          semester of gains.
        </p>
        ...
        <p className="body-1">
          ...
          but I'm likely forgetting a few. Anyhow, I had a 1-month winter break
          after that, where I went to China and Japan.
        </p>
        ...
        <p className="body-1">
          ...
          philosophy essays I wrote in that class. Here are a couple of my best
          ones:
        </p>
        <section className="pdf-picker">
          <button
        ...
        <p className="body-1">
          ...
          because of my performances in the CCL and active involvement in the
          club last semester. One cool thing I did as officer was organizing a
        ...
        <p className="body-1">
          ...
          in (math, CS, chess, poker, strategy games, etc). I spent a lot of
          time in late January preparing my application to UCF, which consisted
          of 3 rounds - a written assessment, trading games, and an interview.
        </p>
        <p className="body-1">
        ...
        <p className="body-1">
          ...
          in the same room. However, I've definitely been inspired by the work I
          see in this club - it's motivated me to study CS and finance this
          summer more in-depth. I hope that next semester I can contribute even
          more, by being more knowledgeable as a whole. Overall I am relatively
          satisfied with the work I did; one of the 10 market watches I wrote
          this semester is attached below.
        </p>
        <section className="pdf-picker">
          <button
            className="pdf-picker-btn"
        ...
        <p className="body-1">
          ...
          regrettably ended up not going to any tournaments with the team due to
          UCF-related time commitments.
        </p>
        <p className="body-1">
          ...
          Fall. I also want to start swimming and running again, both this
        ...
        <p className="body-1">
          ...
          more books, working on side projects, and job recruiting. To do that,
          I'll have to somehow squeeze out ~2-3 hours more every day, which
          means less doomscrolling 😦.
        </p>
      </SectionWrapper>
    </PageLayout>
  );
