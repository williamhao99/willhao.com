    ...
    <PageLayout>
      ...
      <SectionWrapper>
        <ContentLayout>
          ...
          <p className="body-1">
            I've always liked doing math and solving puzzles since I was a kid,
            so most of what I do today relates to that in some way. In middle
            and high school, my biggest time commitments were competitive math
            and programming contests, varsity swim, and managing a chess
            organization (
            <a
          ...
          <p className="body-1">
            ...
            learning more about financial markets or trading, coding projects,
